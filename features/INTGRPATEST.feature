...
# ============================================================================================================
    ...
    @TRA_PAFS_INT_GROUP_A @TRA_INTA1
    Scenario: Submit a new EA proposals (Integration Test EA) with a single Risk Source: river, Funding Source: grant in aid, Risk: VS Before and LR After 
    Given I enter a test project name "Pafs_Integration_A1"
      ...
      And I enter the projects goal approach "A new EA proposals (Integration Test EA) with a single Risk Source: river, Funding Source: grant in aid, Risk: VS Before and LR After "
      And I enter no environmental outcomes improvements
      And I select the project urgency as "not_urgent"
      And I upload a project funding calculator file for option "Yes", "PFCalcVs2020EA.xlsx"
      And I select the confidence page
      And I add the confidence in number of homes better protected by this project as "low"
      And I add the confidence in homes being delivered by the projects Gateway 4 Readiness for Service date as "low"
    ...
    @TRA_PAFS_INT_GROUP_A @TRA_INTA2
    Scenario: Submit a new LA proposals (Integration Test LA) with a single Risk Source: tidal, Funding Source: local levey, Risk: VS Before and LR After 
    Given I enter a test project name "Pafs_Integration_A2"
      ...
      And I add the standard of protection before project starts as "very_significant_risk"
      And I add the standard of protection after project completes as "low_risk"
      And I enter the projects goal approach "A new LA proposals (Integration Test LA) with a single Risk Source: tidal, Funding Source: local levey, Risk: VS Before and LR After "
      And I enter no environmental outcomes improvements
      And I select the project urgency as "stat_need"
      And I enter the project urgent message box of "Because Stats Needed"
      And I upload a project funding calculator file for option "Yes", "PFCalcVs2020LA.xlsx"
      And I select the confidence page
      ...
      And I add the confidence in securing the required Partnership Funding as "high"
      And I select the carbon page
      And I add how much capital carbon will this project produce in tonnes "1"
      And I add how much carbon will this project’s assets produce in their lifecycle "4"
    When I complete my proposal on training
    Then I should see that my proposal is sent for review

    @TRA_PAFS_INT_GROUP_A @TRA_INTA3
    Scenario: Submit a new HA proposals (Integration Test HA) with a single Risk Source: ground, Funding Source: public sector, Risk: Low Before and Low After
    Given I enter a test project name "Pafs_Integration_A3"
      ...
      And I add the standard of protection after project completes as "low_risk"
      And I enter the projects goal approach "A new HA proposals (Integration Test HA) with a single Risk Source: ground, Funding Source: public sector, Risk: Low Before and Low After"
      And I enter no environmental outcomes improvements
      And I select the project urgency as "legal_need"
      And I enter the project urgent message box of "Because it a legal need"
      And I upload a project funding calculator file for option "Yes", "PFCalcVs2020HA.xlsx"
      And I select the confidence page
      And I add the confidence in number of homes better protected by this project as "high"
      And I add the confidence in homes being delivered by the projects Gateway 4 Readiness for Service date as "low"
      And I add the confidence in securing the required Partnership Funding as "low"
    ...
    @TRA_PAFS_INT_GROUP_A @TRA_INTA4
    Scenario: Submit a new IDB proposals (Integration Test IDB) with a single Risk Source: surface, Funding Source: Private Sector, Risk: Low Before and Low After
    Given I enter a test project name "Pafs_Integration_A4"
      ...
      And I add the standard of protection before project starts as "low_risk"
      And I add the standard of protection after project completes as "low_risk"
      And I enter the projects goal approach "A new IDB proposals (Integration Test IDB) with a single Risk Source: surface, Funding Source: Private Sector, Risk: Low Before and Low After"
      And I enter no environmental outcomes improvements
      ...
      And I upload a project funding calculator file for option "Yes", "PFCalcVs2020IDB.xlsx"
      And I select the confidence page
      And I add the confidence in number of homes better protected by this project as "low"
      And I add the confidence in homes being delivered by the projects Gateway 4 Readiness for Service date as "high"
      And I add the confidence in securing the required Partnership Funding as "high"
      And I select the carbon page
      And I add how much capital carbon will this project produce in tonnes "2"
      And I add how much carbon will this project’s assets produce in their lifecycle "1"
    When I complete my proposal on training
    Then I should see that my proposal is sent for review

    @TRA_PAFS_INT_GROUP_A @TRA_INTA5
    Scenario: Submit a new WC proposals (Integration Test WC) with a single risk source amd with move households 
    Given I enter a test project name "Pafs_Integration_A5"
      ...
      And I answer NO if the project could start sooner
      And I enter the projects goal approach "New WC proposals (Integration Test WC) with a single risk source amd with move households "
      And I enter no environmental outcomes improvements
      And I select the project urgency as "time_limit"
      And I enter the project urgent message box of "Because it is an Time Limit"
      And I upload a project funding calculator file for option "Yes", "PFCalcVs2020WC.xlsx"
      And I select the confidence page
      And I add the confidence in number of homes better protected by this project as "low"
      And I add the confidence in homes being delivered by the projects Gateway 4 Readiness for Service date as "low"
      And I add the confidence in securing the required Partnership Funding as "low"
