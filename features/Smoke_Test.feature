...
# ==================================================================================================================================
  ...
  @QA_SmokeTests @OM_QA2
    Scenario: Sumbmit a new proposal with Grant in Aid and Levy funding and PFC VS8 for QA
    Given I select a project type "change_or_new_asset"
      And I select a financial year to stop spending
  ...
  @QA_SmokeTests @OM_QA3
    Scenario: Sumbmit a new proposal with Grant in Aid and Levy funding and PFC VS2020 for QA
    Given I select a project type "change_or_new_asset"
      And I select a financial year to stop spending
      And I add a location "ST 58198 72725"
      And I upload a benefit area file "Valid_ShapeFile.zip"
...
# ==================================================================================================================================
  ...
  Scenario: Created proposal is in draft status for training
    ...
    @TRA_SmokeTests @TRA_SM2
    Scenario: Sumbmit a test proposal with Grant in Aid and Levy funding and PFC VS8 on training
  ...
  @TRA_SmokeTests @TRA_SM3
    Scenario: Sumbmit a test proposal with Grant in Aid and Levy funding and PFC VS2020 on training
    Given I select a project type "change_or_new_asset"
      And I select a financial year to stop spending
      And I add a location "ST 58198 72725"
      And I upload a benefit area file "Valid_ShapeFile.zip"
      ...
      And I enter the projects goal approach "A new proposal with Grant in Aid, Levy funding and PFC VS2020 Calculator on training"
      And I enter environmental outcomes improvements
...
# ==================================================================================================================================
  ...
  @Pre_SmokeTests @Pre_SM1
  Scenario: Created proposal is in draft status for pre-pord
    Given I select a project type "benefits_households_yes"
      And I select a financial year to stop spending
    When I return to the proposal overview page
    Then its status is draft

  @Pre_SmokeTests @Pre_SM2
    Scenario: Sumbmit a test proposal with Grant in Aid and Levy funding and PFC VS8 on pre-prod
    Given I select a project type "property_level_protection"
      And I select a financial year to stop spending
      And I add a location "ST 58198 72725"
      And I upload a benefit area file "Valid_ShapeFile.zip"
      ...
      And I enter environmental outcomes improvements
      And I select the project urgency as "emergency" with a project message of "There is an emergency"
      And I upload a PFC calculator file "PFCalcVs8.xlsx"
